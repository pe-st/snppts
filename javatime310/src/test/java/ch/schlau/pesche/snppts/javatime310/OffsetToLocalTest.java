...
public class OffsetToLocalTest {

    OffsetToLocal mapper = new OffsetToLocal();

    @Test
    public void mapToLocal_winterTime() throws Exception {
    ...
    @Test
    public void mapToLocal_summerTime() throws Exception {
